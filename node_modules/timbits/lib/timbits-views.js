...
(function() {
      ...
      return div({
        ...
        if (!(this.tests != null)) {
          return div({
            ...
            return h3("No timbits exist yet, base testing of timbits server passes however.");
          });
        }
      });
    });
  ...
  exports.timbit_test = function() {
    ...
    return div({
      ...
      var failed, passed, test, _i, _len, _ref, _ref1, _ref2;
      h1({
        "class": 'test_title'
      }, function() {
        return "Testing Summary, Timbit: '" + this.timbit + "'";
      });
      div({
        "class": 'test_views'
      }, function() {
      ...
      if (((_ref = this.required) != null ? _ref.length : void 0) > 0) {
        div({
          "class": 'test_required_params'
        }, function() {
          img({
            src: '/images/brick_add.png',
            "class": 'icon'
          });
          h4('Required Parameters');
          return ul(function() {
            var required, _i, _len, _ref1, _results;
            _ref1 = this.required;
            _results = [];
            for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
              required = _ref1[_i];
      ...
      if (((_ref1 = this.optional) != null ? _ref1.length : void 0) > 0) {
        div({
          "class": 'test_optional_params'
        }, function() {
          img({
            src: '/images/brick_add.png',
            "class": 'icon'
          ...
          return ul(function() {
            var optional, _i, _len, _ref2, _results;
            _ref2 = this.optional;
            _results = [];
      ...
      if (this.warnings.length > 0) {
        return div({
          ...
          return table(function() {
            ...
            return tbody(function() {
              var warning, _j, _len1, _ref3, _results;
              _ref3 = this.warnings;
              _results = [];
              for (_j = 0, _len1 = _ref3.length; _j < _len1; _j++) {
                warning = _ref3[_j];
                _results.push(tr(function() {
                  return td(warning.message);
                }));
              }
              return _results;
            });
